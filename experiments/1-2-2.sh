...
#SBATCH --output=log/1-2-2/runh_%A_%a.out # %A is SLURM_ARRAY_JOB_ID, %a is SLURM_ARRAY_TASK_ID make sure you create the log folder
#SBATCH --error=log/1-2-2/runh_%A_%a.err
...
python train_redq_sac_exp1-2-2.py --setting ${SLURM_ARRAY_TASK_ID}
echo "DONE"