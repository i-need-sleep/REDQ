...
#SBATCH --output=log/1-1-1/runh_%A_%a.out # %A is SLURM_ARRAY_JOB_ID, %a is SLURM_ARRAY_TASK_ID make sure you create the log folder
#SBATCH --error=log/1-1-1/runh_%A_%a.err
