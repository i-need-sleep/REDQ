...
#SBATCH --output=log/2_load/runh_%A.out # %A is SLURM_ARRAY_JOB_ID, %a is SLURM_ARRAY_TASK_ID make sure you create the log folder
#SBATCH --error=log/2_load/runh_%A.err
...
python train_redq_sac_exp2_load.py
echo "DONE"