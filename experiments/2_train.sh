...
#SBATCH --array=0-1 # here the number depends on number of jobs in the array, 0-4 means 0, 1, 2, 3, 4, a total of 5 jobs
#SBATCH --output=log/2_train/runh_%A_%a.out # %A is SLURM_ARRAY_JOB_ID, %a is SLURM_ARRAY_TASK_ID make sure you create the log folder
#SBATCH --error=log/2_train/runh_%A_%a.err
