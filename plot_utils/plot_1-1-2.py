...
variants = ['sac_poly0', 'sac_poly0.01', 'sac_poly0.3']
for env in env_names:
    for value in value_list:
        list_of_data_seeds = []
        label_list = [i.replace('poly','alpha') for i in variants]
        ...
        try:
            os.mkdir('../figures/1-1-2/')
        except:
            pass
        save_loc = '../figures/1-1-2/sac_polyak_%s_%s.png' % (env, value)
