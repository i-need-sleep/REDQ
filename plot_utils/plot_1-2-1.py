...
variants = ['sac_poly(256, 256)', 'sac_poly(512, 512)', 'sac_poly(128, 128, 128, 128)']
for env in env_names:
    for value in value_list:
        list_of_data_seeds = []
        label_list = [i.replace('poly','hidden_size') for i in variants]
        ...
        try:
            os.mkdir(f'../figures/{experiment_id}/')
        except:
            pass
        save_loc = f'../figures/{experiment_id}/sac_polyak_{env}_{value}.png'
